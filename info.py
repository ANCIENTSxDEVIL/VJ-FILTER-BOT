...
# Bot information
SESSION = environ.get('SESSION', 'DEVILSBOT')
API_ID = int(environ.get('API_ID', '20387396'))
API_HASH = environ.get('API_HASH', '5d0752347e9974a1636f02f8d3d434ff')
BOT_TOKEN = environ.get('BOT_TOKEN', "8191147075:AAFcTzAujF7SdDIbKPjOPVNgZBUePiSmLGk")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002460625117'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6637227162').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002106454131').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002460625117') # give your force subscribe channel id here else leave it blank
